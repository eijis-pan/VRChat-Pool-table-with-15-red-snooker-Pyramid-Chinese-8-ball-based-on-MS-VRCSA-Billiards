...
public class AdvancedPhysicsManager_V05M : UdonSharpBehaviour
{
#if EIJIS_MANY_BALLS
    public string PHYSICSNAME = "<color=#FFD700>Advanced V0.5M</color><color=#FF8000>M</color><color=#FFD700>(max32balls)</color>";
#else
